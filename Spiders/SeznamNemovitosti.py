...
class SeznamNemovitosti(scrapy.Spider):
    ...
    # sem pujde vysledek z lr_list_spider misto natvrdo zadane adresy
    start_urls = [
        "http://nahlizenidokn.cuzk.cz/ZobrazObjekt.aspx?encrypted=bUrsf"
        "-lRpqts8K2Hs6RMGr7HX0ngePvoeENqwacpHvYeDAaFHPMjHGC-ywuB0VXlshMm06eThAMsf0fpS2dnMs"
        "-sJgVzO4lUJDDAy5lEnHupuz_LVpSKaw=="]
    ...
    def parse(self, response):
        ...
        for link in response.css(
            ...
            next_url['url'] = link.css(
                "a::attr(href)").extract()  # link: ZobrazObjekt.aspx?encrypted=*shitloadkodu==* ktery se musi spojit
            # s predponou "http://nahlizenidokn.cuzk.cz/"
            yield next_url
